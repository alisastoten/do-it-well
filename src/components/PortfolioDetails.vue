<template>
    <div class="flex flex-col md:flex-row items-center justify-center mt-10">
      <img :src="job.img" alt="Job Image" class="w-5/6 md:w-2/10 rounded-3xl" />
      <div class="mx-10 mt-5 md:mt-20 text-white w-5/6 md:w-4/10">
        <h1 class="text-3xl mb-5">{{ job.name }}</h1>
